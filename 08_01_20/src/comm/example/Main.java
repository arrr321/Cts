...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        pa[0] = new TV(8000, "Samsung", 30);
        pa[1] = new TV(10000, "Sony", 50);
        pa[2] = new Mp3player(1500, "Apple", "blue");
        pa[3] = new Book(500, "Sun press", 1992);
        pa[4] = new Book(600, "Korea press", 1986);
